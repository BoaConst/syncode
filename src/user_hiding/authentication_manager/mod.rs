...
impl fmt::Display for DvcsAuthError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            DvcsAuthError::InvalidPermission => write!(f, "Invalid permission"),
...
// Implementing the get_user_permissions function -> Vec<String> 
fn get_user_permissions(username: &str, repository: &Repository) {
    // TO DO: implement this function
